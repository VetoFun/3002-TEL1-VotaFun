...
class Chatgpt:
    ...
    def chatgpt_func(self, data, database):
        """
        ...
        activity_matches = re.findall(self.activity_regex, chatgpt_reply)
        question_matches = re.findall(self.question_regex, chatgpt_reply)
        option_matches = re.findall(self.option_regex, chatgpt_reply)
